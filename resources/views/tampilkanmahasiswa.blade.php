...
<head>
    ...
    <title>Mahasiswa - ITB STIKOM BALI</title>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom container">
    ...
    <div class="container">
    <form class="form-inline" action="/pilihangkatanmahasiswaandroid" method="get" style="float:left; padding-right:10px;">
        ...
        <form class="form-inline" style="float:left;" action="/carimahasiswaandroid" method="get">            
        ...
        <form class="table-responsive" style="float:left;">            
            <label class="mr-sm-2"><font style="font-family:verdana;font-size:12pt;color:black;">Jumlah Mahasiswa : {{$mahasiswa->count()}}</font></label>
        </form>
        ...
        <div class="card" style="max-width: 540px;">
                <div class="col-md-4">
			        <img src="{{asset('uploads/mahasiswa/'. $li->image)}}" width="100%" height="100%" alt="image">
                </div>
			<div class="card-body">
				<h5>{{$li->nama_lengkap}}</h5>
				<p>Angkatan : {{$li->angkatan}}</p>
                <p>Status : {{$li->status_mahasiswa}}</p>
				<p>Jenis Kelamin : {{$li->jenis_kelamin}}</p>
                <a href="/detailmahasiswa/{{$li->id}}" class="btn btn-primary" style="float:right;"><span class="fa fa-eye"></span> Lihat Detail</a>
			</div>
		</div>
        </div>
@endforeach
...
<div class="table-responsive">
        <div class="card" style="max-width: 540px;">
			<div class="card-body">
				<p style="font-family:sans-serif;font-size:14pt;"><center><b>Mahasiswa Tidak Ditemukan</b></center></p>
			</div>
		</div>
        </div>
@endif
