...
<head>
    ...
    <title>Tambah Dokumen - ITB STIKOM BALI</title>
                ...
                <div class="sidebar-sticky">
                    <ul class="nav flex-column" data-widget="treeview" role="menu" data-accordion="false"><br>
                        ...
                        <li class="nav-item">
                            ...
                            <span class="fas fa-angle-down" style="float:right;"></span></a>
                                <ul class="nav nav-treeview">
                                    <a class="nav-link active" href="tambahdokumen"><span class="fa fa-plus"></span>
                                    Tambah Dokumen
                                    </a>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom container">
            <h1><font style="font-family:verdana;font-size:20pt;color:black;">Tambah Dokumen</font></h1>
        </div>
        <div class="container">
            <form class="was-validated" action="{{url('tambahdokumen/prosestambahdokumen')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Masukkan Judul Dokumen" name="judul_dokumen" class="form-control col-md-6" required>
                    <div class="valid-feedback">Data Sudah Lengkap.</div>
                    <div class="invalid-feedback">Data Kurang Lengkap.</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" placeholder="Masukkan Deskripsi Dokumen" cols="40" rows="5" name="deskripsi" class="form-control col-md-6" required></textarea>
                    <div class="valid-feedback">Data Sudah Lengkap.</div>
                    <div class="invalid-feedback">Data Kurang Lengkap.</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" placeholder="Masukkan Foto Dokumen" name="image" class="form-control col-md-6" required>
                    <div class="valid-feedback">Data Sudah Lengkap.</div>
                    <div class="invalid-feedback">Data Kurang Lengkap.</div>
                </div>
