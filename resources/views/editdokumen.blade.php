...
<head>
    ...
    <title>Ubah Dokumen - ITB STIKOM BALI</title>
...
<!--Content (Isi)-->
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom container">
            <h1><font style="font-family:verdana;font-size:20pt;color:black;">Ubah Dokumen</font></h1>
        </div>
            <div class="container">
                <form class="was-validated" action="/prosesubahdokumen/{{$dokumen->id}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="id" id="id" value="{{ $dokumen->id}}">
                <div class="form-group">
                    <label><font style="font-family:verdana;font-size:12pt;color:black;">Tahun Dokumen :</font></label>
                    <select class="form-control col-md-6" name="tahun_dokumen" required>
                            <option value="">Pilih tahun</option>
                            <option value="2020" @if($dokumen->tahun_dokumen=='2020') selected='selected' @endif >2020</option>
                            <option value="2019" @if($dokumen->tahun_dokumen=='2019') selected='selected' @endif >2019</option>
                            <option value="2018" @if($dokumen->tahun_dokumen=='2018') selected='selected' @endif >2018</option>
                            <option value="2017" @if($dokumen->tahun_dokumen=='2017') selected='selected' @endif >2017</option>
                            <option value="2016" @if($dokumen->tahun_dokumen=='2016') selected='selected' @endif >2016</option>
                            <option value="2015" @if($dokumen->tahun_dokumen=='2015') selected='selected' @endif >2015</option>
                            <option value="2014" @if($dokumen->tahun_dokumen=='2014') selected='selected' @endif >2014</option>
                            <option value="2013" @if($dokumen->tahun_dokumen=='2013') selected='selected' @endif >2013</option>
                    </select>
                ...
                <div class="form-group">
                    <label><font face="verdana" size="3" color="black">Judul Dokumen : </font></label>
                    <input type="text" placeholder="Masukkan Judul Dokumen" name="judul_dokumen" class="form-control col-md-6" value="{{$dokumen->judul_dokumen}}" required>
                    <div class="valid-feedback">Data Sudah Lengkap.</div>
                    <div class="invalid-feedback">Mohon Maaf, Data Kurang Lengkap. Harap Dilengkapi.</div>
                </div>

                <div class="form-group">
                    <label><font face="verdana" size="3" color="black">Deskripsi : </font></label>
                    <textarea type="text" placeholder="Masukkan Deskripsi Dokumen" cols="40" rows="5" name="deskripsi" class="form-control col-md-6" required>{{$dokumen->deskripsi}}</textarea>
                    <div class="valid-feedback">Data Sudah Lengkap.</div>
                    <div class="invalid-feedback">Mohon Maaf, Data Kurang Lengkap. Harap Dilengkapi.</div>
                </div>

                <div class="form-group">
                    <label><font face="verdana" size="3" color="black">Foto Dokumen :</font></label>
                    <input type="file" placeholder="Masukkan Foto Dokumen" name="image" class="form-control col-md-6" value="{{$dokumen->image}}" required>
                    <div class="valid-feedback">Data Sudah Lengkap.</div>
                    <div class="invalid-feedback">Mohon Maaf, Data Kurang Lengkap. Harap Dilengkapi.</div>
                </div>
