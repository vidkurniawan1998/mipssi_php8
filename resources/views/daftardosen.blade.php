...
<head>
    ...
    <title>Mengelola Dosen - ITB STIKOM BALI</title>
            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column" data-widget="treeview" role="menu" data-accordion="false"><br>
                        <li class="nav-item">
                            <a class="nav-link" href="halamanutama"><span class="fa fa-home"></span>
                            Halaman Utama
                        ...
                        <li class="nav-item">
                            ...
                            <span class="fas fa-angle-down" style="float:right;"></span></a>
                                <ul class="nav nav-treeview">
                                    ...
                                    <a class="nav-link active" href="daftardosen"><span class="fa fa-user-graduate"></span>
                                    Mengelola Dosen
                                    </a>
                                </ul>
                        </li>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <form class="form-inline" action="/pilihpendidikanterakhir" method="get" style="float:left; padding-right:10px;">
        <label class="mr-sm-2"><font style="font-family:verdana;font-size:12pt;color:black;">Pendidikan Terakhir:</font></label>
                <select class="form-control mb-2 mr-sm-2 btn btn-sm btn-outline-primary dropdown-toggle" name="pendidikan_terakhir">
        ...
        <form class="form-inline" style="float:right;" action="/caridosen" method="get" style="float:left">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr class="table-light text-dark">
                    ...
                    <td>{{$li->pendidikan_terakhir}}</td>
                    <td><img src="{{asset('uploads/dosen/'. $li->image)}}" width="100px" height="100px" alt="image"></td>
                    <td>
                        <a href="/editdosen/{{$li->id}}" class="btn btn-primary"><span class="fa fa-edit"></span>Ubah</a>
                        <a href="/hapusdosen/{{$li->id}}" class="btn btn-danger" onclick="return confirm('Yakin Ingin Menghapus Data Ini?');"><span class="fa fa-trash"></span>Hapus</a>
                    </td>
                </tr>
                @endforeach
                @else
                <tr>
                    <td colspan="5"><center><b>Data Dosen Tidak Ditemukan</b></center></td>
                </tr>
                @endif
            </table>
        </div>
        Jumlah Data : {{$dosen->count()}} dari {{$dosen->total()}}
        <br>
        {{ $dosen->links() }}
