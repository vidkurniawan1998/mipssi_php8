...
<head>
    ...
    <title>Staff - ITB STIKOM BALI</title>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom container">
        <h1><font style="font-family:verdana;font-size:20pt;color:black;">Staff</font></h1>
    </div>
    
        <div class="container">
        <form class="form-inline" action="/pilihjabatanandroid" method="get" style="float:left; padding-right:10px;">
        <label class="mr-sm-2"><font style="font-family:verdana;font-size:12pt;color:black;">Jabatan:</font></label>
                <select class="form-control btn-outline-primary dropdown-toggle" name="jabatan" style="width:100%;height:100%;">
        ...
        <form class="form-inline" style="float:left;" action="/caristaffandroid" method="get">            
        ...
        <form class="table-responsive" style="float:left;">            
            <label class="mr-sm-2"><font style="font-family:verdana;font-size:12pt;color:black;">Jumlah Staff : {{$user->count()}}</font></label>
        </form>

        @if(count($user) > 0)
        @foreach($user as $index => $li)
        <div class="table-responsive">
        <div class="card" style="max-width: 540px;">
                <div class="col-md-4">
			        <img src="{{asset('uploads/staff/'. $li->image)}}" width="100%" height="100%" alt="image">
                </div>
			<div class="card-body">
				<h5>{{$li->nama_lengkap}}</h5>
				<p>Jabatan : {{$li->jabatan}}</p>
                <p>Email : {{$li->email}}</p>
                <a href="/detailstaff/{{$li->id}}" class="btn btn-primary" style="float:right;"><span class="fa fa-eye"></span>Lihat Detail</a>
			</div>
		</div>
        </div>
@endforeach
...
<div class="table-responsive">
        <div class="card" style="max-width: 540px;">
			<div class="card-body">
				<p style="font-family:sans-serif;font-size:14pt;"><center><b>Staff Tidak Ditemukan</b></center></p>
			</div>
		</div>
        </div>
@endif
