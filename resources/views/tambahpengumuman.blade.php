...
<head>
    ...
    <title>Tambah Pengumuman - ITB STIKOM BALI</title>
                        ...
                        <li class="nav-item">
                            ...
                            <span class="fas fa-angle-down" style="float:right;"></span></a>
                                <ul class="nav nav-treeview menu-open">
                                   <a class="nav-link active" href="tambahpengumuman"><span class="fas fa-plus"></span>
                                        Tambah Pengumuman
                                   </a>
...
<!--Content (Isi)-->
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom container">
            <h1><font style="font-family:verdana;font-size:20pt;color:black;">Tambah Pengumuman</font></h1>
        </div>
            <div class="container">
                <form class="was-validated" action="{{url('/tambahpengumuman/prosestambahpengumuman')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Masukkan Judul Pengumuman" class="form-control col-md-6" name="judul_pengumuman" required>
                        <div class="valid-feedback">Data Sudah Lengkap.</div>
                        <div class="invalid-feedback">Data Kurang Lengkap.</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" placeholder="Masukkan Deskripsi" cols="40" rows="5" class="form-control col-md-6" name="deskripsi" required></textarea>
                        <div class="valid-feedback">Data Sudah Lengkap.</div>
                        <div class="invalid-feedback">Data Kurang Lengkap.</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" placeholder="Masukkan Tanggal Pengumuman" name="tanggal_pengumuman" class="form-control col-md-6" required>
                        <div class="valid-feedback">Data Sudah Lengkap.</div>
                        <div class="invalid-feedback">Data Kurang Lengkap.</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" placeholder="Masukkan Data Foto Pengumuman" class="form-control col-md-6" name="image" required>
                        <div class="valid-feedback">Data Sudah Lengkap.</div>
                        <div class="invalid-feedback">Data Kurang Lengkap.</div>
                    </div>
