...
<head>
    ...
    <title>Mengelola Pengumuman - ITB STIKOM BALI</title>
                        ...
                        <li class="nav-item">
                            ...
                            <span class="fas fa-angle-down" style="float:right;"></span></a>
                                <ul class="nav nav-treeview">
                                    ...
                                    <a class="nav-link active" href="daftarpengumuman" style="font-size:11pt;"><span class="fa fa-envelope"></span>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <form class="form-inline" action="/pilihangkatan" method="get" style="float:left; padding-right:10px;">
        ...
        <form class="form-inline" style="float:right;" action="/caripengumuman" method="get" style="float:right;">
        ...
        <table class="table table-bordered table-hover">
            <tr class="table-primary text-light">
                ...
                <th><center>Tanggal Pengumuman</center></th>
            ...
            <tr class="table-light text-dark">
                ...
                <td>{{$li->angkatan}}</td>
                <td>{{$li->judul_pengumuman}}</td>
                <td>{{$li->deskripsi}}</td>
                <td>{{$li->tanggal_pengumuman}}</td>
                <td><img src="{{asset('uploads/pengumuman/'. $li->image)}}" width="100px" height="100px" alt="image" onerror="this.src='uploads/pengumuman/logo pdf.jpg'"></td>
                <td>
                    <a href="/editpengumuman/{{$li->id}}" class="btn btn-primary"><span class="fa fa-edit"></span>Ubah</a>
                    <a href="/hapuspengumuman/{{$li->id}}" class="btn btn-danger" onclick="return confirm('Yakin Menghapus Data Ini?');"><span class="fa fa-trash"></span>Hapus</a>
                </td>
            </tr>
            @endforeach
            @else
            <tr>
                <td colspan="7"><center><b>Data Pengumuman Tidak Ditemukan</b></center></td>
            </tr>
            @endif
        </table>
        </div>
        Jumlah Data : {{$pengumuman->count()}} dari {{$pengumuman->total()}}
        <br><br>
        {{$pengumuman->links()}}
